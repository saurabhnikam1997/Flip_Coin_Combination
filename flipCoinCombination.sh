...
function Winner()
{
        if [[ $singletCombination -gt $doubletCombination && $singletCombination -gt $tripletCombination ]]
        then
                echo "Singlet Combination is Winning Combination"
        elif [[ $doubletCombination -gt $singletCombination && $doubletCombination -gt $tripletCombination ]]
        then
                echo "doublet Combination is Winning Combination"
        else
                echo "triplet combination is winning combination"
        fi
}
